...
public class IambackofficeTwoFactorMethod {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticator, email, id, method, mobilePhone, secret);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IambackofficeTwoFactorMethod.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IambackofficeTwoFactorMethod` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
